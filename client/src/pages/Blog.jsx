  ...
  return data ? (
    <div>
      ...
      <div className="text-center mt-10 text-gray-600">
        ...
        <h1 className="text-2xl sm:text-5xl font-semibold text-gray-800 max-w-2xl mx-auto">
          {data.title}
        </h1>
        <h2
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="font-semibold mb-4">
            {comments.map((item, index) => (
              <div
                key={index}
                className="relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded text-gray-600 mb-2"
              >
        ...
        <div className="my-18 max-w-3xl mx-auto">
